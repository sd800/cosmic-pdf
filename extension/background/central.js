...
chrome.runtime.onMessage.addListener((message,sender,respond)=>{
  ...
  else if(message?.type==='OPEN_SETTINGS' && sender.url?.startsWith(chrome.runtime.getURL('workspaces/pdf-reader/index.html'))) job=start().then(()=>operations.openSettings());
